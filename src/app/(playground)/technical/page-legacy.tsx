        ...
        <div className="flex flex-col">
            ...
            <div className='text-sm'>
                <p className='mt-3 text-sm'>
                    ...
                    indices of the two numbers such that they add up to <code className="bg-secondary p-1 text-xs rounded-sm w-fit h-auto">target</code>.
                </p>
                <p className='mt-3'>
            ...
            <div className="examples flex flex-col gap-y-2 my-4">
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        ...
                        <div className='example-card bg-muted rounded-sm'>
                            <pre>
